...
* Not every feature that spawns a drama thread on weku.io necessarily
...
* Product improvement suggestions are encouraged, however they should be
  sent to [sneak@weku.io](mailto:sneak@weku.io) for review.

* Working code (usually) trumps all.  Requests to make changes to
  weku.io that include working, tested Pull Requests jump to the top of
