...
function sortOrderToLink(so, topic, account) {
    ...
    if (so === 'aboutweku') return 'https://weku.io';
    //if (so == 'chat') return 'http://weku.io/chat';
    //if (so == 'video') return 'http://weku.io/tube';
...
class Header extends React.Component {
    ...
    render() {
        ...
        if (route.page === 'PostsIndex') {
            ...
            page_title = `Pick Your New WEKU Account`;
                    ...
                    <div className="expanded row">
                        <div className="columns">
                            <ul className="menu">
                                ...
                                <li className="Header__top-steemit show-for-medium noPrint"><Link to={logo_link}>
