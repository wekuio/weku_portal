    ...
    render() {
        ...
        if (this.props.serverBusy || $STM_Config.disable_signups) {
            return <div className="row">
                <div className="column callout" style={{margin: '20px', padding: '40px'}}>
                    <p>Membership to weku.io is now under invitation only because of unexpectedly high sign up rate.
        ...
        return <div className="SignUp">
            <div className="row">
                <div className="column">
                    <h3>Sign Up</h3>
                    <p>WEKU funds each account with over {this.props.signup_bonus} worth of WEKU Power; to prevent abuse, we
            ...
            <div className="row">
                <div className="column">
                      <br />
                    <p className="secondary">By verifying your account you agree to the WEKU <a href="/tos.html" target="_blank">terms and conditions</a>.</p>
                </div>
            </div>
        </div>
    }
