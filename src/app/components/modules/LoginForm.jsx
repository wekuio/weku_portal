...
class LoginForm extends Component {
    ...
    render() {
        ...
        const {username, password, saveLogin, recaptcha} = this.state;
        ...
        const form = (
            ...
            >
                ...
                <div>
                    <label className="LoginForm__save-login" htmlFor="saveLogin">
                        ...
                        <input id="saveLogin" type="checkbox" ref="pw" {...saveLogin.props}
                               onChange={this.saveLoginToggle} disabled={submitting}/></label>
                </div>
                <div>
                    <br/>
                ...
                <div>
                    <hr/>
                    <p>{tt('loginform_jsx.join_our')} <span
                        className="free-slogan">{tt('loginform_jsx.amazing_community')}</span>{tt('loginform_jsx.to_comment_and_reward_others')}
                    </p>
                    <button type="button" className="button sign-up"
                            onClick={this.SignUp}>Sign up for free</button>
                </div>
            </form>
        );
        return (
            <div className="LoginForm row">
                <div className="column">
                    ...
                    {/*<ReCAPTCHA
                        ref="recaptcha"
                        sitekey="6LfAsnoUAAAAAAbB1WJk-vV-Gf2N0H2yNhliVJqd"
                        onChange={this.onRecapcha}
                    />*/}
                </div>
            </div>
        )
...
function checkPasswordChecksum(password) {
    // A Weku generated password is a WIF prefixed with a P ..
