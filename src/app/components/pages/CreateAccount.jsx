            ...
            return <div className="row">
                <div className="column">
                    ...
                    <div className="callout alert">
                        <p>Membership to WEKU.io is now under invitation only because of unexpectedly high sign up rate.</p>
                    </div>
                </div>
            </div>;
        }
                ...
                <div className="column">
                    ...
                    <div className="callout alert">
                        ...
                        <p>The latest versions of <a href="https://www.google.com/chrome/">Chrome</a> and <a href="https://www.mozilla.org/en-US/firefox/new/">Firefox</a>
                            are well tested and known to work with WEKU.com.</p>
                    </div>
                </div>
            </div>;
        }
                ...
                <div className="column">
                    ...
                    <div className="callout alert">
                        <p>It looks like your sign up request is not approved yet or you already created an account.<br />
                           Please try again later or contact <a href="mailto:support@WEKU.io">support@WEKU.io</a> for the status of your request.<br />
        ...
        return (
            <div>
                <div className="CreateAccount row">
                    <div className="column">
                        <h4>{tt('g.rule_info')}</h4>
                        {/*<Progress tabIndex="0" value={95} max={100} />*/}
                        {showRules ? <div className="CreateAccount__rules">
                            <p>
                                The first rule of WEKU is: Do not lose your password.<br />
                                The second rule of WEKU is: Do <strong>not</strong> lose your password.<br />
                                The third rule of WEKU is: We cannot recover your password, or your account if you lose your password.<br />
                                ...
                                access to an account without knowing the password.  WEKU is a
                            ...
                            <a className="CreateAccount__rules-button" href="#" onClick={() => this.setState({showRules: true})}>{tt('g.rule_label')} &nbsp; &raquo;</a>
                        </div>}
                        <br />
                        <form onSubmit={this.onSubmit} autoComplete="off" noValidate method="post">
                            <div className={name_error ? 'error' : ''}>
                            <label>{tt('g.signup_name')}
                            ...
                            <input disabled={submit_btn_disabled} type="submit" className={submit_btn_class} onClick={this.mousePosition} value={tt('g.create_account')} />
                        </form>
                    </div>
                </div>
            </div>
