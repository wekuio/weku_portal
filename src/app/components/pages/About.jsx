            ...
            <div className="row">
                <div className="column">
                    ...
                    <p>
                        ...
                        <a href="https://weku.io/">{tt('about_jsx.learn_more_at_app_url', {APP_URL})}</a>.
                    </p>
                    <h2>{tt('about_jsx.resources')}</h2>
                    <h3><a href="https://www.weku.io/weku_whitepaper_en.pdf" onClick={this.navigate}>{tt('navigation.APP_NAME_whitepaper', {APP_NAME})}</a> <small>[PDF]</small></h3>
                </div>
            </div>
        );
    }
