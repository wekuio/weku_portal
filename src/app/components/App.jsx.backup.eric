...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        // loading google translate scripts
            ...
            callout = <div className="App__announcement row">
                <div className="column">
                    <div className={classNames('callout success', {alert}, {warning}, {success})}>
                        ...
                        <ul>
                            <li>
                                /*<a href="https://weku.io/weku/@wekublog/weku-com-is-now-open-source">
                                   ...STORY TEXT...
                                </a>*/
                            </li>
                        </ul>
                ...
                <div className="welcomeWrapper">
                    <div className="welcomeBanner">
                        ...
                        <div className="text-center">
                            ...
                            &nbsp; &nbsp; &nbsp;
                            <a className="button hollow uppercase" href="https://weku.io" target="_blank" rel="noopener noreferrer" onClick={this.learnMore}> <b>{tt('navigation.learn_more')}</b> </a>
                            <br />
                            <br />
                        </div>
                    </div>
        ...
        return <div className={'App' + (lp ? ' LP' : '') + (ip ? ' index-page' : '') + (miniHeader ? ' mini-header' : '')}
            ...
            <SidePanel ref="side_panel" alignment="right">
                ...
                <ul className="vertical menu">
                    ...
                    <li>
                        <a href="/status" onClick={this.navigate}>
                            Chain Status
                        </a>
                    </li>
                    {/*
                ...
                <ul className="vertical menu">
                    <li>
                        <a href="https://weku.io/home" target="_blank" rel="noopener noreferrer">
                            {tt('navigation.chat')}&nbsp;<Icon name="extlink" />
                        </a>
                    </li>

                    <li>
                        <a href="https://weku.io/" onClick={this.navigate} target="_blank" rel="noopener noreferrer">
                            {tt('navigation.app_center')}&nbsp;<Icon name="extlink" />
                        </a>
                    </li>

                    <li className="last">
                        <a href="https://weku.github.io/weku-docs/" target="_blank" rel="noopener noreferrer">
                ...
                */}
                ...
                <ul className="vertical menu">
                    <li>
                        <a href="https://weku.io" target="_blank" rel="noopener noreferrer">
                            About Weku Team
                        </a>
                    </li>
                    {!is_iOS &&
                    ...
                    <li className="last">
                        <a href="https://news.weku.io" target="_blank" rel="noopener noreferrer">
                            news.weku
                        </a>
                    </li>
                </ul>
                ...
                <ul className="vertical menu">
                    <li>
                        <a href="https://www.weku.io/weku_whitepaper_en.pdf" onClick={this.navigate}>
                            {tt('navigation.whitepaper')}&nbsp;<Icon name="extlink" />
                        </a>
                    </li>
                    <li>
                        <a href="/about.html" onClick={this.navigate}>
