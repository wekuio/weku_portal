...
async function appRender(ctx) {
    ...
    try {
        ...
        const { body, title, statusCode, meta } = await universalRender({host: ctx.host, location: decodeURIComponent(ctx.request.url), store, offchain, ErrorPage, tarantool: Tarantool.instance()});
