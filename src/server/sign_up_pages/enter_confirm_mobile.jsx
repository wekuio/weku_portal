...
import awsSNS from 'server/utils/awsSNS';
...
// step 6: after confirm email, user need to confirm phone
function* confirmMobileHandler(e) {
    ...
    if (user.account_status === 'onhold') yield user.update({account_status: 'approved'});
    if (mixpanel)
    ...
    const mid2 = yield models.Identity.findOne({
        where: { user_id: user.id, provider: 'email' }
    });
    this.redirect('/start/' + mid2.confirmation_code);
}
...
export default function useEnterAndConfirmMobilePages(app) {
                    ...
                    <div className="column">
                        ...
                        >
                            ...
                            <div className="secondary">
                                We need to send a SMS to you.
                                <br />
                                Phone validation is used to filter out robot register.
                                <br />
                                <em>
                                    Your phone number is only used during registering or account recovery.
                                    Will not be used for any other case.
                                </em>
                            </div>
                            <br />
                            ...
                            <div className="secondary">
                                example: 541-754-3010 | 89-636-48018
                            </div>
                            <br />
                            <div className="secondary">
                                * Wired phone might not be able to receive SMS.
                            </div>
                            <div className="secondary">
                                * SMS might cause fee.
                            </div>
    ...
    router.post("/submit_mobile", koaBody, function*() {
        ...
        const verifyResult = yield awsSNS.verifyAndSend(phone, confirmation_code);
        ...
        // hardcode for testing
        //const verifyResult = {phone:phone, score: 100, };
        ...
        const body = renderToString(
            <div className="App">
                ...
                <div className="row" style={{ maxWidth: "32rem" }}>
                    <div className="column">
                        <Progress tabIndex="0" value={90} max={100} />
                        Thanks for providing your phone (
                        {phone}
                        ).
                        <br />
                    </div>
