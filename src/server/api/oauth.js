...
function* handleFacebookCallback() {
    ...
    try {
        ...
        if (account_recovery_record) {
            if (user) {
                ...
                if (existing_account) {
                    ...
                    this.body = 'We cannot verify the user account. Please contact support@weku.io';
                }
            } else {
        ...
        // }
        // if (!u.verified) {
        //     throw new Error('Not verified Facebook account. Please verify your Facebook account and try again to sign up to WeKu.');
        // }
    ...
    return new Promise((resolve, reject) => {
        reddit.query()
            ...
            .headers({
                ...
                'User-Agent': 'wekubot/1.0 (+http://weku.io)',
